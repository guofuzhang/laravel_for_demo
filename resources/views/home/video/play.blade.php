...
<body>
    ...
    <div class="learing-course">
        <div>
            <!--<link rel="import" href="/home//home/modules/ui-modules/learing-course-weeklist/learing-course-weeklist.html?__inline">-->
...
<div class="video text-center" style='width:900px;height:450px;background-color:pink;clear:both;margin:auto;' id="show_video">
                        </div>
<script type="text/javascript">
var flashvars={
        f:'{{$pullurl}}',       //拉拉地址
        i:'/storage/video/12790984079221.jpg',//视频封面图
        d:'/storage/video/12791611288398.jpg|/storage/video/12791611289197.jpg',//暂停时播放的广告图片
        v:'60',//默认音量，0-100之间
        p:'0',//视频默认0是暂停，1是播放
        lv:'0',//是否是直播流，=1则锁定进度栏
        c:0,
...
CKobject.embedSWF('/ckplayer/ckplayer.swf','show_video','ckplayer_a1','900','450',flashvars,params);
</script>
