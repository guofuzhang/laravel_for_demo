...
$(function(){
    $('#leixing input').click(function(){
		...
		var duo_answer = '<label class="form-label col-xs-4 col-sm-3">正确答案：</label> <div class="formControls col-xs-8 col-sm-9"> A:<input type="checkbox" name="qs_answer[]" value="1" />&nbsp;&nbsp; B:<input type="checkbox" name="qs_answer[]" value="2" />&nbsp;&nbsp; C:<input type="checkbox" name="qs_answer[]" value="4" />&nbsp;&nbsp; D:<input type="checkbox" name="qs_answer[]" value="8" />&nbsp;&nbsp; </div>';
		...
		* */
		var dan_answer = '<label class="form-label col-xs-4 col-sm-3">正确答案：</label> <div class="formControls col-xs-8 col-sm-9"> A:<input type="radio" name="qs_answer[]" value="1" />&nbsp;&nbsp; B:<input type="radio" name="qs_answer[]" value="2" />&nbsp;&nbsp; C:<input type="radio" name="qs_answer[]" value="4" />&nbsp;&nbsp; D:<input type="radio" name="qs_answer[]" value="8" />&nbsp;&nbsp; </div>';
		if($(this).val()=='单选'){
...
$(function(){
	...
	$('#form-admin-add').submit(function(evt){
		...
		//执行ajax
		$.ajax({
			url:'/admin/question/tianjia/'+'{{$paper->paper_id}}',
			data:shuju,
			dataType:'json',
			type:'post',
